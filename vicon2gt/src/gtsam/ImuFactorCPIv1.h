...
private:
  ...
  bool estimate_gravity; ///< flag to estimate gravity XY rotation or not
...
public:
  ...
  ImuFactorCPIv1(Key state_i, Key state_j, Key rotxy, Eigen::Matrix<double, 15, 15> covariance, double deltatime, double grav_m,
                 ...
                 Eigen::Matrix3d J_alpha, Eigen::Matrix3d H_beta, Eigen::Matrix3d H_alpha, bool est_grav)
    ...
    this->estimate_gravity = est_grav;
  }
